...
- **Fase Ideal recalculada** pela Tabela 4 do documento PEDE (divergia da base em 15,6% das linhas) e **cascata propagada**: Fase Ideal → Defasagem → IAN (Tabela 41, 100% de conformidade) → INDE → Pedra. As colunas originais ficam preservadas com sufixo `_base`.
