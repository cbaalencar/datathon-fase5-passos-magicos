...
with aba_ind:
    ...
    with col_e:
        ...
        modo_def = st.radio("Defasagem", ["Informar diretamente", "Calcular pelo ano de nascimento"],
                            horizontal=True, label_visibility="collapsed")
        if modo_def == "Calcular pelo ano de nascimento":
            ...
            st.markdown(
                f'<div class="calc">Idade: {idade} · Fase ideal (Tabela 4): '
                f'{ideal} · <b>Defasagem calculada: {defasagem:+d}</b></div>',
                unsafe_allow_html=True)
        else:
