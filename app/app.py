...
MODELO_PATH = "modelo_risco_defasagem.pkl"
META_PATH = "modelo_meta.json"
...
try:
    ...
    st.error(
        ...
        "`modelo_risco_defasagem.pkl` e `modelo_meta.json` estão na raiz do "
        f"repositório e se o `requirements.txt` fixa scikit-learn==1.6.1.\n\nDetalhe: {e}"
    )
    st.stop()
