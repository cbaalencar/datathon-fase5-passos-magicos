...
[data-testid="stSlider"] [role="slider"] {{ background-color: {AZUL} !important; }}
[data-testid="stSlider"] > div > div > div > div {{ background: {AZUL} !important; }}
.stTabs [aria-selected="true"] {{ color: {MARINHO} !important; }}
.rotulo {{
